  ...
  properties: {
    ...
    metrics: {
      ...
      properties: {
        ...
        memory_audits: { type: "integer", minimum: 0 },
        postmortems_generated: { type: "integer", minimum: 0 },
        parallel_dispatches: { type: "integer", minimum: 0 },
        integrated_tasks: { type: "integer", minimum: 0 },
        integration_conflicts: { type: "integer", minimum: 0 },
        learning_cycles: { type: "integer", minimum: 0 },
        skill_health_refreshes: { type: "integer", minimum: 0 },
        pattern_candidates_generated: { type: "integer", minimum: 0 },
        roadmap_reassessments: { type: "integer", minimum: 0 },
        process_reports_generated: { type: "integer", minimum: 0 },
      },
    },
  },
};
...
export const lockRecordSchema: Schema = {
  ...
  properties: {
    ...
    lock_kind: { enum: ["resource", "integration", "workspace"] },
